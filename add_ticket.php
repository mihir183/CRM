        ...
        <div class="container mt-3">
            ...
            <form action="insert_ticket.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col">
                        ...
                        <div class="row row-cols-2 mb-1">
                            ...
                            <div class="col">
                                ...
                                <input type="text" id="serial" name="serial_number" class="form-control mb-2" required>
                            </div>
                        </div>
                ...
                <div class="row row-cols-2 mb-4">
                    <div class="col">
                        <label for="given" class="form-label text-capitalize">given by<span
                                class="text-danger">*</span></label>
                        <input type="text" name="given_by" id="given" class="form-control" required>
                    </div>
                    <div class="col">
                        <label for="mobile" class="form-label text-capitalize">mobile number<span
                                class="text-danger">*</span></label>
                ...
                <div class="row justify-content-end">
                    <div class="col col-4">
                        <button class="btn btn-primary mb-5 text-capitalize w-100"><i
