...
$products = mysqli_query($conn, "SELECT p_id, p_name, variant, product_key FROM products ORDER BY p_name ASC");
?>
    ...
    <form action="insert_client.php" onsubmit="beforeSubmit(event)" id="myForm" method="post">
      ...
      <div class="row mb-3 row-cols-1">
        <div class="col col-4">
          ...
          <input type="text" class="form-control" name="l_key" id="l_key" placeholder="License Key" required readonly>
        </div>
      </div>
